...
public final class MasternodeSyncLoader extends AsyncTaskLoader<Integer>
{
	...
	public MasternodeSyncLoader(final Context context, org.bitcoinj.core.Context ctpContext)
	{
		super(context);

		//this.broadcastManager = LocalBroadcastManager.getInstance(context.getApplicationContext());
		this.masternodeSync = ctpContext.masternodeSync;
		this.masternodeSyncStatus = masternodeSync.getSyncStatusInt();
		this.masternodeManager = ctpContext.masternodeManager;
	}
