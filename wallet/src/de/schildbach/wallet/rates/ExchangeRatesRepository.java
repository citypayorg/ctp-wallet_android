...
public class ExchangeRatesRepository {
    ...
    private void populateExchangeRatesStack() {
        ...
        exchangeRatesClients.push(CtpRatesSecondFallback.getInstance());
        exchangeRatesClients.push(CtpRatesFirstFallback.getInstance());
        exchangeRatesClients.push(CtpRatesClient.getInstance());
        exchangeRatesClients.push(CtpRetailClient.getInstance());
    }
