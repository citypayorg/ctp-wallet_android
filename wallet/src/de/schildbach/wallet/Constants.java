...
public final class Constants {
    ...
    static {
        switch (BuildConfig.FLAVOR) {
            ...
            case "_testNet3": {
                ...
                WALLET_NAME_CURRENCY_CODE = "tctp";
                break;
            }
            case "devNet": {
                DNS_SEED = new String[]{
    ...
    public static final String REPORT_EMAIL = "support@ctp.org";

    /** Subject line for manually reported issues. */
    public static final String REPORT_SUBJECT_BEGIN = "Android Ctp Wallet:  ";
    ...
    public static String NOTIFICATION_CHANNEL_ID_TRANSACTIONS = "ctp.notifications.transactions";
    public static String NOTIFICATION_CHANNEL_ID_ONGOING = "ctp.notifications.ongoing";
    ...
    public static String WALLET_URI_SCHEME = "ctpwallet";
