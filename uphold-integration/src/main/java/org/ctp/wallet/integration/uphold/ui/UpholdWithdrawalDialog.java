...
package org.ctp.wallet.integration.uphold.ui;
...
import org.ctp.wallet.integration.uphold.R;
import org.ctp.wallet.integration.uphold.data.UpholdClient;
import org.ctp.wallet.integration.uphold.data.UpholdConstants;
import org.ctp.wallet.integration.uphold.data.UpholdTransaction;
...
public class UpholdWithdrawalDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(final Bundle savedInstanceState) {
        ...
        final CurrencyAmountView ctpAmountView = view.findViewById(R.id.send_coins_amount_ctp);
        ctpAmountView.setCurrencySymbol(currencyCode);
        ctpAmountView.setInputFormat(inputFormat);
        ctpAmountView.setHintFormat(hintFormat);
        ctpAmountView.getTextView().setText(balance.toString());
        ctpAmountView.getTextView().addTextChangedListener(ctpAmountTextWatcher);

        TextView hintView = view.findViewById(R.id.hint);
        hintView.setText(Html.fromHtml(getString(R.string.ctp_available, balance)));
        ...
        dialog.setOnShowListener(new DialogInterface.OnShowListener() {
            ...
            public void onShow(DialogInterface d) {
                ...
                transferButton.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        transfer(new BigDecimal(ctpAmountView.getTextView().getText().toString()),
                                false);
                    }
                });
            }
    ...
    private TextWatcher ctpAmountTextWatcher = new TextWatcher() {
        @Override
    ...
    private void transfer(BigDecimal value, final boolean deductFeeFromAmount) {
        ...
        UpholdClient.getInstance().createCtpWithdrawalTransaction(value.toPlainString(),
