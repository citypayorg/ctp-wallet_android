...
public class UpholdConstants {
    ...
    public static final String CARD_URL_BASE = "https://sandbox.uphold.com/ctpboard/cards/%s/add";
    public static final String TRANSACTION_URL = "https://sandbox.uphold.com/reserve/transactions/%s";
    public static final String LOGOUT_URL = "https://sandbox.uphold.com/ctpboard";
