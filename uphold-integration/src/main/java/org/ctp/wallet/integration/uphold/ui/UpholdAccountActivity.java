...
import org.ctp.wallet.common.customtabs.CustomTabActivityHelper;
...
public class UpholdAccountActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        findViewById(R.id.uphold_buy_ctp_btn).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openBuyCtpUrl();
            }
    ...
    private void loadUserBalance() {
        ...
        UpholdClient.getInstance().getCtpBalance(new UpholdClient.Callback<BigDecimal>() {
            @Override
    ...
    private void openBuyCtpUrl() {
        UpholdCard ctpCard = UpholdClient.getInstance().getCurrentCtpCard();
        if (ctpCard != null) {
            final String url = String.format(UpholdConstants.CARD_URL_BASE, ctpCard.getId());
